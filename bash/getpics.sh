...
# download a tar file of pictures to Pictures Directory if it isn't there 
test -f ~/Pictures/pics.tgz || wget -q -O ~/Pictures/pics.tgz http://zonzorp.net/pics.tgz

# extracting tar file using -zxvf option and -C to extract in custom director then removing file
test -f ~/Pictures/pics.tgz && tar -zxvf ~/Pictures/pics.tgz -C ~/Pictures/ && rm ~/Pictures/pics.tgz
